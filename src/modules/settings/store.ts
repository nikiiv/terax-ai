...
const KEY_ELIXIR_LS_PATH = "elixirLsPath";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    elixirLsPath:
      get<string>(KEY_ELIXIR_LS_PATH) ?? DEFAULT_PREFERENCES.elixirLsPath,
    favoriteModelIds:
...
export async function setElixirLsPath(value: string): Promise<void> {
  await writePref(KEY_ELIXIR_LS_PATH, value);
}
...
export async function onPreferencesChange(
  ...
  const map: Record<string, PrefKey> = {
    ...
    [KEY_ELIXIR_LS_PATH]: "elixirLsPath",
